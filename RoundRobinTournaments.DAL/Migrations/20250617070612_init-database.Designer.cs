...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.GameRoundPlayerTournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.InscriptionPlayerTournament", b =>
                {
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.Tournament", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.Utilisateur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MM_Tournament_Category", b =>
                {
                    b.HasOne("RoundRobinTournaments.Domain.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("category_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoundRobinTournaments.Domain.Models.Tournament", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.GameRoundPlayerTournament", b =>
                {
                    b.HasOne("RoundRobinTournaments.Domain.Models.Utilisateur", "Black")
                        .WithMany("BlackMatches")
                        .HasForeignKey("black_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("RoundRobinTournaments.Domain.Models.Tournament", "Tournament")
                        .WithMany("Rounds")
                        .HasForeignKey("tournament_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RoundRobinTournaments.Domain.Models.Utilisateur", "White")
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.InscriptionPlayerTournament", b =>
                {
                    b.HasOne("RoundRobinTournaments.Domain.Models.Utilisateur", "Player")
            ...
            modelBuilder.Entity("RoundRobinTournaments.Domain.Models.Tournament", b =>
                {
                    b.HasOne("RoundRobinTournaments.Domain.Models.Location", "Location")
